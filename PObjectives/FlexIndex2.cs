...
{
    public class FlexIndex2<Tkey> : IIndex
    {
        ...
        public FlexIndex2(string indexName, PaEntry table, Func<PaEntry, Tkey> keyProducer, IComparer<Tkey> comparer)
        {
            this.table = table;
        ...
        private PaEntry GetFirstFromByKey0(PaCell i_cell, Tkey key)
        {
            PaEntry entry = table.Element(0);
