...
{
    public class RPack : ICloneable
    {
        //public bool result;
        public object[] row;
        private readonly TripleStore ts;
        ...
        public RPack ResetDiapason(short parametersStartIndex, short parametersEndIndex)
        {
