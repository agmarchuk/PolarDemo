...
namespace BigDbTest
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            BigSQL bs = new BigSQL(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=D:\home\FactographDatabases\test.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            bs.Test2("randcol>777777770 AND randcol<777779000");
            Console.WriteLine("duration=" + (DateTime.Now - tt0).Ticks / 10000L); tt0 = DateTime.Now;
