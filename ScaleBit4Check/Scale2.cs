...
{
    // Ўкала однобитных величин
    // Ўкала двухбитных величин
    public class Scale2
    {
        // ранг шкалы, т.е. длина индекса в битах, напр. дл€ шкалы, содержашей 1024 битовых пары, ранг будет 10  
        private int range;
        public int[] arr;
        ...
        // ћетоды дл€ получени€ занчени€ шкалы из внешнего массива целых (файла последовательности целых)
